...
<span class="logo-lg"><b>Laporan Bulanan </b></span>
  ...
  <nav class="navbar navbar-static-top" role="navigation">
	...
	<img src="../assets/images/admin.png" class="user-image" alt="images">
  <span class="hidden-xs"><?php echo $_SESSION['role']; ?></span>
          </a>
          <ul class="dropdown-menu">
            <!-- User image -->
            <li class="user-header">
	              <img src="../assets/images/admin.png" class="img-circle" alt="images">
...
<form method="GET">
  ...
  <br>
    ...
    <a href="surat_add.php" class="btn btn-info btn-sm"><b>Kirim Laporan Bulanan</a></b>
