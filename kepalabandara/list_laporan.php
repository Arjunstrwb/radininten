...
if ($tgl_mulai != "" AND $tgl_sampai != "") {
	$querydokumen = mysqli_query ($connect, "SELECT * FROM dokumen WHERE tujuan_dokumen ='kepala bandara' AND tanggal_dokumen BETWEEN '$tgl_mulai' AND '$tgl_sampai' ORDER BY id DESC");
} else {
	$querydokumen = mysqli_query ($connect, "SELECT * FROM dokumen WHERE tujuan_dokumen ='kepala bandara'ORDER BY id DESC");
}
