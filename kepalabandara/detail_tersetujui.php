...
$querydokumen = mysqli_query ($connect, "SELECT nomor_dokumen, nama_dokumen, tanggal_dokumen, tujuan_dokumen, file_dokumen, komentar FROM dokumen WHERE status='1' AND tanggal_dokumen BETWEEN '$tgl_mulai' AND '$tgl_sampai' ORDER BY id DESC");
} else {
$querydokumen = mysqli_query ($connect, "SELECT nomor_dokumen, nama_dokumen, tanggal_dokumen, tujuan_dokumen, file_dokumen, komentar FROM dokumen WHERE status='1' ORDER BY id DESC");
}
