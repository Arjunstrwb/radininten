...
<span class="logo-lg"><b>Daftar Pengguna</b></span>
</div>
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <ul class="sidebar-menu">					
						<li class="header"><h4><b><center>Manajemen User</center></b></h4></li>
            <li class="active"><a href="home.php"><i class="fa fa-home"></i><span>Dashboard</span></a></li>	
            <li><a href="users.php"><i class="fa fa-list-ul"></i><span>Daftar Surat Tersetujui</span></a></li>
            <li><a href="dokter.php"><i class="fa fa-user"></i><span>Daftar Pengguna</span></a></li>
            <li><a href="obat.php"><i class="fa fa-list-ul"></i><span>Data Keseluruhan Surat Masuk</span></a></li>
          </ul>
        </section>
    <!-- /.sidebar -->
  </aside>  
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
                  <br><a href="#"><button class="btn btn-success" type="button" data-target="#ModalAdd" data-toggle="modal"><i class="fa fa-plus"></i> Add</button></a>
