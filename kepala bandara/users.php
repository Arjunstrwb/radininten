...
<html>
<head>
<title>Daftar Surat | Approved</title>
<meta charset="utf-8">
...
<span class="logo-lg"><b>Persetujuan Surat</b></span>
</div>
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <ul class="sidebar-menu">					
						<li class="header"><h4><b><center>Daftar Surat</center></b></h4></li>
            ...
            <li><a href="obat.php"><i class="fa fa-user"></i><span>Daftar Pengguna Sistem</span></a></li>
          </ul>
        </section>
    <!-- /.sidebar -->
  </aside>  
...
<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Data Surat Tersetujui dan Disimpan Anda
          </h1>
